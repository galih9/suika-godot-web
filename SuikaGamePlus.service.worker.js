...
/** @type {string} */
const CACHE_VERSION = '1736911157|444171775';
/** @type {string} */
const CACHE_PREFIX = 'SuikaGamePlus-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'SuikaGamePlus.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["SuikaGamePlus.html","SuikaGamePlus.js","SuikaGamePlus.offline.html","SuikaGamePlus.icon.png","SuikaGamePlus.apple-touch-icon.png","SuikaGamePlus.worker.js","SuikaGamePlus.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["SuikaGamePlus.wasm","SuikaGamePlus.pck"];
